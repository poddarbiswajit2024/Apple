<%@ Page Title="" Language="C#" MasterPageFile="~/UI/BillingAndCustomerCare/CustomerCare/CustomerCare.Master" AutoEventWireup="true" EnableEventValidation = "false" CodeBehind="BroadbandUsersDocuments.aspx.cs" Inherits="Apple_Bss.UI.BillingAndCustomerCare.CustomerCare.BroadbandUsersDocuments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
       ...
       <%--  <asp:Label ID="Label1" runat="server"></asp:Label>-SCLX <asp:TextBox ID="TextBox1" runat="server" CssClass="TextBoxBorder" MaxLength="4" Width="90px"></asp:TextBox> --%>



<asp:Label ID="Label2" runat="server"></asp:Label>-SCLX <asp:TextBox ID="_tbUserID" runat="server" CssClass="TextBoxBorder" Font-Names="Arial" Font-Size="9pt" MaxLength="4" Width="116px" Height="16px"></asp:TextBox>
                ...
                <tr>
                    <td class="mainTD" valign="top">
                        ...
                        <asp:TemplateField HeaderText="ADDPROOFNAME">
                                ...
                                <%--     <asp:BoundField DataField="CAFANNEXURENAME" HeaderText="CAFANNEXURENAME" SortExpression="CAFANNEXURENAME">
                                </asp:BoundField>   --%>            
                           ...
                           <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:INETBILLDIMAPURConnectionString %>" SelectCommand="SELECT [USERID], [USERNAME], [CAFNUMBER], [CAFDOCUMENTNAME], [CAFANNEXURENAME], [IDPROOFNAME], [PHOTOFILENAME], [ADDPROOFNAME], [IDPROOFTYPE], [ADDRESSPROOFTYPE] FROM [USERMASTER] where status='A'"></asp:SqlDataSource>--%>
