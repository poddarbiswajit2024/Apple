<%@ Page Language="C#" MasterPageFile="~/UI/BillingAndCustomerCare/CustomerCare/CustomerCare.Master"
    AutoEventWireup="true" CodeBehind="CollectionReportDayWise.aspx.cs" Inherits="Apple_Bss.UI.BillingAndCustomerCare.CustomerCare.CollectionReportDayWise"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="tableStyle" align="center">
                            ...
                            <tr>
                                ...
                                <td class="tdStyle">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="_txtStartDate" ErrorMessage="* Select  Date"></asp:RequiredFieldValidator>
                                    
                                </td>
                                <td class="tdStyle">
                                    <asp:ImageButton ID="_btnShow" runat="server" ImageUrl="~/Images/Buttons/View.jpg" OnClick="_btnShow_Click" />
                                </td>
                                <td class="tdStyle">
                                    &nbsp;</td>
                            </tr>
