...
{
    public partial class BillPlanChangeWithoutSecurityDeposit : System.Web.UI.Page
    {
                        ...
                        if (Convert.ToInt32(_ddlBillCycle.SelectedValue) >= currentbillcycle)
                        {
                            ...
                            if (currPayMode == "M")//for all cycles other than monthly
                            {
                                ...
                                else
                                {
                                    ...
                                    buser.ChangeBillPlanwithoutChargesDifference(_userID, currBillPlanID, _ddlNewBillPlans.SelectedValue.ToString(), currPayMode, newPayMode, Convert.ToInt32(_ddlBillCycle.SelectedValue.ToString()), Session["EmpID"].ToString(), Convert.ToDateTime(datepicker.Value, ci).ToShortDateString());
