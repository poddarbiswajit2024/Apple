<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TechnicalSupport/HelpDesk/HelpDesk.Master" AutoEventWireup="true" CodeBehind="SMS_SRDetails.aspx.cs" Inherits="Apple_Bss.UI.TechnicalSupport.HelpDesk.SMS_SRDetails" %>
                    ...
                    <td class="mainTD">
                        ...
                        <table class="tableStyle" cellspacing="0" cellpadding="0" border="0" align="center">
                            ...
                            <tr>
                                ...
                                <td class="tdStyle">
                                    <asp:Label ID="lblSRID" runat="server" ForeColor="Red"></asp:Label>
                                  
                                </td>
                            </tr>
                            <tr>
                                <td class="tdStyle" width="15%">
                                    SMS received on(Date/Time)
                                </td>
                                <td class="tdStyle">
                                    <asp:TextBox ID="_txtStartDate" Enabled="False" runat="server" CssClass="TextBoxBorder" Width="200px" />
                            ...
                            <tr>
                                ...
                                <td class="tdStyle">
                                    <asp:TextBox ID="_tbIssueReported" runat="server" AutoCompleteType="FirstName" MaxLength="50"
                                        Rows="3" Enabled="False" TextMode="MultiLine" Width="450px" CssClass="TextBoxBorder" Height="50px"></asp:TextBox>
                    ...
                    <td class="mainTD">
                        ...
                        <table class="tableStyle" cellspacing="0" cellpadding="0" border="0" align="center">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:ImageButton ID="_btnRegisterSR" runat="server" OnClick="_btnRegisterSR_Click" ImageUrl="~/Images/Buttons/Updateservicerequest.jpg"/>
