...
{
    public partial class EditRegistrationQuick : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request["id"] != null)
                {
                    ...
                    _tbAltNumber.Text = buser.AlternativeMobileNumber;
        ...
        protected void _imgBtnCustDetailUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                RegisteredBroadbandUsers buser = new RegisteredBroadbandUsers();
                if (!buser.CheckCAFNumberExists(tbCAFNumber.Text, regpendinguserid))
                {
                    ...
                    {
                        buser.UpdateCustProfileDetails(regpendinguserid, _tbCustomerName.Text, _tbInstallationAddress.Text, _tbCorresspondenceAddress.Text, "", _tbAltNumber.Text, _tbMobileNumber.Text, _tbEmailID.Text, tbCAFNumber.Text, ResidentialCheckBox.Text, _txtUserGSTIN.Text);
                    }
                    else if (CommercialCheckBox.Checked)
                    {
                        buser.UpdateCustProfileDetails(regpendinguserid, _tbCustomerName.Text, _tbInstallationAddress.Text, _tbCorresspondenceAddress.Text, "", _tbAltNumber.Text, _tbMobileNumber.Text, _tbEmailID.Text, tbCAFNumber.Text, CommercialCheckBox.Text, _txtUserGSTIN.Text);
                    }
                }
        ...
        protected void _imgBtnBillPlanUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                RegisteredBroadbandUsers buser = new RegisteredBroadbandUsers();
        ...
        private void ClearForm()
        {
            ...
            _tbAltNumber.Text = String.Empty;
        }
