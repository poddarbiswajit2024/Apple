<%@ Page Title="" Language="C#" MasterPageFile="~/UI/MarketingAndSales/SalesHead/SalesMaster.Master" AutoEventWireup="true" CodeBehind="ManagerejectedPaperless.aspx.cs" Inherits="Apple_Bss.UI.MarketingAndSales.SalesHead.ManagerejectedPaperless" %>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><span class="text-semibold">Manage Rejected Registrations</span></h4>
						</div>
					</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Sales Head Home > Manage Rejected Registrations</li>
						</ul>
                                                ...
                                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                                        ...
                                                        <table class="table table-responsive table-togglable table-hove " style="width:100%;" id="myTable">
                                                          ...
                                                          <thead> 
                                                            <tr>  
                                                                ...
                                                                <th data-hide="phone">Reason For Rejection</th>
                                                    ...
                                                    <ItemTemplate>               
                                                     ...
                                                     <td>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="dop" runat="server" Text='<%# Eval("ReasonForRejection") %>' />
                                                        </td>
                                                         <td>
                                                      ...
                                                      <%--      <asp:ImageButton ID="ImageButton_Delete" runat="server" AlternateText="Delete" style="border: 0;float:left; margin:3px;"  CausesValidation="false"
                                                            ...
                                                            <asp:ImageButton ID="ImageButton_Delete" runat="server" AlternateText="Resend For Varification" style="border: 0;float:left; margin:3px;"  CausesValidation="false"
                                                               CommandArgument='<%# Eval("USERID") %>' CommandName="Delete" ImageUrl="~/Images/Buttons/Resend.png"                                                              
                                                              ToolTip="Resend for Verification"  height="20" width="20" />
                                                        </td>
