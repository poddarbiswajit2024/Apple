<%@ Page Title="" Language="C#" MasterPageFile="~/UI/MarketingAndSales/SalesHead/SalesHead.Master" AutoEventWireup="true" CodeBehind="ManageRejectedRegistrationsAll.aspx.cs" Inherits="Apple_Bss.UI.MarketingAndSales.SalesHead.ManageRejectedRegistrationsAll" %>
                                            ...
                                            <td>
                                                <asp:GridView ID="_gvPendingConnection" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ReasonForRejection" HeaderText="Reason For Rejection">
                                                    ...
                                                    &nbsp;&nbsp;<img src="../../../Images/Buttons/dots.gif" border="0" />&nbsp;&nbsp;
                                                        ...
                                                        <%--        <asp:ImageButton ID="ImageButton_Delete" runat="server" AlternateText="Delete" CausesValidation="false"
                                                                  ...
                                                                  <asp:ImageButton ID="ImageButton_Delete" runat="server" AlternateText="Resend For Varification" style="border: 0; margin:3px;"  CausesValidation="false"
