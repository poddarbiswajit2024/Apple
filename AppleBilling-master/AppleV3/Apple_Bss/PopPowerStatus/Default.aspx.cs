    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(Request.QueryString["location"]!="")
            {
                ...
                {
                    case "DIMAPUR" :
                        PopulatePOPListingByStatusandLocation("DMP");
                        hlDimpaur.ForeColor = System.Drawing.Color.Red;
                        break;
                    case "KOHIMA":
                          PopulatePOPListingByStatusandLocation("KOH");
                          hlKohima.ForeColor = System.Drawing.Color.Red;
                        break;
                    case "MOKOKCHUNG":
                        PopulatePOPListingByStatusandLocation("MKG");
                        hlMokokchung.ForeColor = System.Drawing.Color.Red;
                        break;
                    default:
                        PopulatePOPListingByStatus();
                        hlAll.ForeColor = System.Drawing.Color.Red;
                        break;
                }
            }
                else
        ...
        private void PopulatePOPListingByStatusandLocation(string pLocationCode)
        {
            try
            {
                gvPopList.DataSource = Pop.GetPOPPowerListByStatusandLocation(pLocationCode);
                gvPopList.DataBind();
            }
