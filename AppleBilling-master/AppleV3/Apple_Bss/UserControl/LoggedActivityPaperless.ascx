<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoggedActivityPaperless.ascx.cs" Inherits="Apple_Bss.UserControl.LoggedActivityPaperless" %>
    ...
    <ContentTemplate>
        <div style="height: auto;">
            <div class="tdHeader">
                ...
                <div style="float:left;padding-top:5px;"><asp:Label ID="lblToday" runat="server" Text="My Latest Activity"></asp:Label></div>
            </div>
